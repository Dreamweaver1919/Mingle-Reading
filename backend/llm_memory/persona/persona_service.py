...
AGENT_CONFIGS: dict[str, PersonaAgentConfig] = {
    ...
    "lu-xun": PersonaAgentConfig(
        ...
        default_model_name="",
        persona_pack_path="backend/assets/data/processed/personas/persona_lu_xun__v002.json",
        catalog_path="backend/assets/data/raw/persona_sources/catalog_lu_xun__v001.json",
    ...
    "mark-twain": PersonaAgentConfig(
        ...
        default_model_name="",
        persona_pack_path="backend/assets/data/processed/personas/persona_mark_twain__v001.json",
        catalog_path="backend/assets/data/raw/persona_sources/catalog_mark_twain__v001.json",
        prompt_traits=PersonaPromptTraits(
    ...
    "zhang-ailing": PersonaAgentConfig(
        ...
        default_model_name="",
        persona_pack_path="backend/assets/data/processed/personas/persona_zhang_ailing__v001.json",
        catalog_path="backend/assets/data/raw/persona_sources/catalog_zhang_ailing__v001.json",
        prompt_traits=PersonaPromptTraits(
