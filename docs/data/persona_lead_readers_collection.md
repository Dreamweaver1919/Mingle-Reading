...
- one schema-conformant persona pack in `data/processed/personas/`
- multiple source records in `data/raw/persona_sources/`
- a shared registry entry in `data/manifests/persona_lead_readers_registry__v001.json`
- a large-source catalog in `data/raw/persona_sources/catalog_<persona>__v001.json`
- a status summary in `data/manifests/persona_collection_requirements_summary__v001.json`
